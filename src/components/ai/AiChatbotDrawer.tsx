...
id: 'welcome',
sender: 'ai',
text: `Greetings. I am your Spatia architectural design advisor. I am currently monitoring your ${width}×${length} ${unit} space styled in ${THEMES[selectedTheme].name}. How can I assist your layout, hydraulic plumbing, or finish coordination today?`,
timestamp: 'Just now'
}
]);
...
id: `ai-${Date.now()}`,
sender: 'ai',
text: `Reflecting on your ${width}×${length} ${unit} layout in ${currentThemeDef.name}: your selected ${PRODUCT_MAP[selections.faucet]?.name || 'faucet'} harmonizes with the ${PRODUCT_MAP[selections.flooring]?.name || 'flooring'}. All hydraulic rough-in points comply with signature global architectural engineering standards. Would you like me to optimize lighting placement or calculate exact water flow rates?`,
timestamp: 'Just now',
...
Backed by 25-item Spatia Catalog Engine
</p>
</div>
</div>
<button
