        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-10 pb-16 border-b border-stone/20">
          ...
          <div className="lg:col-span-2 space-y-4">
            <div className="flex items-baseline gap-2">
              <span className="font-sans font-black text-2xl tracking-[0.2em] text-porcelain uppercase">
                KOHLER
              </span>
              <span className="font-sans font-light text-2xl tracking-[0.05em] text-stone-light">
                Spatia
              </span>
            </div>
            <p className="text-stone-light text-sm leading-relaxed max-w-sm font-sans">
              The AI-powered bathroom spatial intelligence platform. Harmonizing architectural proportions, hydraulic engineering, and bespoke Kohler metallic finishes into private sanctuaries.
            </p>
