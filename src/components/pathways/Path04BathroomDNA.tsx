    ...
    <div className="py-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto space-y-8 animate-fade-in">
      ...
      <div className="text-center space-y-2">
        ...
        <p className="text-stone-dark text-base sm:text-lg font-medium max-w-2xl mx-auto leading-relaxed">
          Upload 3–5 inspiration images (Pinterest boards, hotel suite photos, architectural clippings). Kohler Spatia's computer vision decodes the common stylistic thread, material palette, and spatial rhythm into an instant starter bundle.
        </p>
      </div>
