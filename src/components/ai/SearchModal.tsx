              ...
              {pairingSuggestions.length > 0 && (
                <div className="p-4.5 bg-porcelain-warm border border-accent/40 rounded-sm mt-4">
                  ...
                  <p className="text-sm text-stone-dark font-medium mb-3">
                    Based on your search for <span className="font-bold text-ink">"{matchingProducts[0].name}"</span>, Kohler Spatia AI identifies harmonizing fixtures for an integrated architectural finish:
                  </p>
