    ...
    <div className="py-6 sm:py-8 space-y-8 animate-fade-in w-full">
      ...
      <div className="text-center max-w-3xl mx-auto space-y-2">
        ...
        <p className="text-stone-dark text-xs sm:text-sm font-medium leading-relaxed">
          Five original architectural compositions curated across Kohler's signature metallic tones. Explore room hotspots, inspect hand-curated specifications, or launch into 3D.
        </p>
      </div>
