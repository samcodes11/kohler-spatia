...
export const AiEnquiryTriage: React.FC<AiEnquiryTriageProps> = ({ onBack }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      let routedDepartment = 'Kohler Technical Engineering Support';
      let draft = '';
      ...
      if (text.includes('leak') || text.includes('defect') || text.includes('scratch') || text.includes('warranty') || text.includes('peel') || text.includes('broken')) {
        ...
        draft = `Dear ${clientName || 'Valued Patron'}, thank you for contacting Kohler Spatia Quality Support. Under Kohler's 10-Year Limited Warranty on PVD finishes and ceramic valves, your installation is fully protected. Our technical field team in your regional metropolitan area has been notified to arrange an on-site inspection or express component replacement.`;
        ...
        draft = `Hello ${clientName || 'Partner'}, regarding your installation inquiry: Kohler concealed wall-hung frames require a minimum 140mm stud cavity depth and 4.0 bar dynamic pressure for optimal flush performance. A dedicated MEP installation schematic has been queued for dispatch to your registered contractor.`;
        ...
        draft = `Dear ${clientName || 'Architect'}, thank you for introducing your luxury residence project. Our senior spatial intelligence fellows specialize in customized non-orthogonal room layouts and material matching. We have reserved a private virtual session at the Kohler Experience Centre.`;
      } else {
        category = 'Product Specification';
        priority = 'Standard';
        routedDepartment = 'Product Catalog & Metallurgy Inquiries';
        draft = `Dear ${clientName || 'Patron'}, thank you for your query regarding Kohler Spatia specifications. All fixtures in our catalog utilize lead-free solid brass forgings and physical vapor deposition finishes exceeding industry ASTM B117 salt spray standards by 400 hours. A technical cut sheet has been generated for your review.`;
      }
    ...
    <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8 space-y-10 animate-fade-in">
      ...
      <div className="text-center space-y-3">
        ...
        <p className="text-stone-dark text-base sm:text-lg font-medium max-w-2xl mx-auto leading-relaxed">
          Skip generic web forms and ticket queues. Kohler Spatia's natural language classifier reads your inquiry, identifies hydraulic/warranty context, generates immediate technical guidance, and routes directly to the certified specialist team.
        </p>
      </div>
